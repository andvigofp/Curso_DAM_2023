...
public class HorarioClaseColores {
    public static void main(String[] args) {
        ...
        lunes = "\033[32mLunes\033[0m";
        martes = "\033[33mMartes\033[0m\n";
        miercoles = "\033[34mMiercoles\033[0m";
        jueves = "\033[36mJueves\33[0m";
        viernes = "\033[31mViernes\33[0m";
        programacion1 = "\033[31mProgramación\033[0m";
        programacion2 = "\033[31mProgramación\033[0m\n";
        psp = "\033[37mPSP\033[0m";
        sxe = "\033[36mSXE\033[0m";
        recreo = "\033[35mRecreo\33[0m";
